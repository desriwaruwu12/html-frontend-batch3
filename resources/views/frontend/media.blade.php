...
<head>
  ...
  <title>Travelxism | Media Production</title>
  ...
  <main id="main">
    ...
    <!-- <section id="destinasi" class="destinasi">
        <div class="section-title">
          <h3>Media <span>Production</span></h3>
        </div>
        <div class="section-heading container">
            <div class="row d-flex justify-content-center">
                <p class="text-center">
                    Dunia digital dan teknologi online telah berperan sangat aktif dalam mengembangkan industri pariwisata saat ini. Travelxism hadir untuk membantu Anda dalam membangun bisnis, memasarkan destinasi ataupun produk di sektor pariwisata. Kami menawarkan program konsultasi kreatif, inovatif dan terintegrasi.
                </p>
            </div>
        </div>
        <div class="section-video">        
          <div class="row card-video">
            <div class="section-title">
              <h4><span class="btn btn-sm btn-primary">Videos</span></h4  >
            </div>
              <div class="card-video-top" style="width: 16rem; border: 5px;">
                <div class="icon">
                    <img src="assets/img/play.png" alt="">
                </div>
                  <img src="assets/img/destinasi/destinasi-3.jpg" alt="...">
              </div>
              <div class="card-video-top" style="width: 16rem;">
                <div class="icon">
                    <img src="assets/img/play.png" alt="">
                </div>
                <img src="assets/img/destinasi/destinasi-3.jpg" alt="...">
    ...
    <div class="section-video-heading">
      <div class="section-title mt-5">
        <h3>Media <span>Production</span></h3>
        <p style="font-weight: normal; width: 70%;">Dunia digital dan teknologi online telah berperan sangat aktif dalam mengembangkan industri pariwisata saat ini. Travelxism hadir untuk membantu Anda dalam membangun bisnis, memasarkan destinasi ataupun produk di sektor pariwisata. Kami menawarkan program konsultasi kreatif, inovatif dan terintegrasi.</p>
      </div>
    </div>
    
    <div class="section-video pt-5">
      <div class="video row d-flex justify-content-center">
        <div class="d-flex justify-content-center">
          <div class="btn btn-sm btn-primary text-center">Our Videos</div>
        </div>
          <div class="card-video-top me-3" style="width: 20rem;">
            <a href="#">
              <div class="icon">
            ...
            <a class="text-center" href="#">Tampilkan Lebih Banyak</a>
      </div>
  </div>

  <div class="container mb-4 section-galery pt-5 pb-1">
    <div class="video row d-flex justify-content-center">
      <div class="d-flex justify-content-center">
        <div class="btn btn-sm btn-primary text-center mb-4">Our Galleries</div>
      </div>
        <div class="card-video-top me-3" style="width: 20rem;">
            <img src="../../../frontend/assets/img/destinasi/destinasi-1.jpg" class="card-img-top" alt="...">
          </div>
